...
#         captchaid_list_resume.append([_][0][0:100] + [_][0][1000:1100] + [_][0][2000:2100])

#     print('até aqui 35 linha captcha.py')
#     # Banco de Captchas
...
#                 df_resultados.loc[df_resultados['Resumo'] == captchaid_list_resume[_]]['Caracter'].iloc[0])
#         except:
#             if captchaid_list_resume[_][25:50] == 'AAPAAAAEAAAJkAAEBAQEBAQIC':  # 6
#                 captcha_answer.append(df_resultados.loc[df_resultados['Caracter'] == '6']['Caracter'].iloc[0])

#             elif captchaid_list_resume[_][25:50] == 'AAPAAAACQAAFoAAHBwcHBwcHB':  # k
#                 captcha_answer.append(df_resultados.loc[df_resultados['Caracter'] == 'k']['Caracter'].iloc[0])

#             elif captchaid_list_resume[_][25:50] == 'AAPAAAADAAAHUAAFRUVFRUVFR':  # f
#                 captcha_answer.append(df_resultados.loc[df_resultados['Caracter'] == 'f']['Caracter'].iloc[0])

#     # Escreve a resposta
#     tempo_aleatorio = random.uniform(1, 2)
#     for _ in captcha_answer:
#         sleep(tempo_aleatorio)
#         captcha_input = driver.find_element(By.XPATH, '//*[@id="form"]/fieldset/fieldset/input')
...
def solve_text_captcha(driver, url):
    ...
    # Banco de Captchas
    conn = sqlite3.connect("C:/Users/40417495/PycharmProjects/pythonProject1/Extracao_Info_B2B/captcha/database2.db")
    cursor = conn.cursor()
    cursor.execute("SELECT * FROM Captcha")
    resultados = cursor.fetchall()
    conn.commit()
