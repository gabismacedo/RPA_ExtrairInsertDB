...
def solve_text_captcha(driver, url):
    ...
    url = f"window.open('https://site-que-tem-o-captha.com/captcha?id={id}', '_blank');"
    ...
    # Banco de Captchas
    conn = sqlite3.connect("C:/Users/PycharmProjects/pythonProject1/Extracao_Info_B2B/captcha/database2.db")
    cursor = conn.cursor()
